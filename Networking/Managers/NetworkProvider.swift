...
class NetworkProvider {
    ...
    #elseif REFACTOR
    func fetchObject<Object>(api: StylishAPIProtocol, type: Object.Type, completion: @escaping (Result<Object, Error>) -> Void) where Object: Decodable {
    ...
    func fetchData(api: StylishAPIProtocol, completion: @escaping (Result<Data, Error>) -> Void) {
